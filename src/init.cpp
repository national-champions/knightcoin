...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/knightcoin-project/knightcoin>";
    const std::string URL_WEBSITE = "<https://knightcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("KnightCoin version %s\n", FormatFullVersion());
}
