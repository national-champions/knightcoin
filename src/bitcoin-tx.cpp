...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s knightcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  knightcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded knightcoin transaction") + "\n" +
              "  knightcoin-tx [options] -create [commands]   " + _("Create hex-encoded knightcoin transaction") + "\n" +
              "\n";
